...
public class IOService {
    ...
    public void write(String path,HashMap<Integer, Service> hashMap)  {
        try {
            ...
            for (Integer key : keys) {
                string += hashMap.get(key).getId() + "," + hashMap.get(key).getServiceName() + "," + hashMap.get(key).getServicePrices() + "," + hashMap.get(key).getAmount() + "/n";
            }
    ...
    public HashMap<Integer,Service> read(String path) throws IOException {
