...
import management.AccountScanner;
import management.ComputerManagement;
import management.RevenueManagement;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        IORevenue ioRevenue=new IORevenue();
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 0:
                    ...
                    ioRevenue.writeData(IORevenue.PATH,revenueManagement.getRevenues());
